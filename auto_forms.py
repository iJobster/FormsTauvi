...
templates = {
    'RH NOSSA': Path("C:/Users/meidelvein.ps/Downloads/Auto/FORM_NOSSA.docx"),
    'CWBEM': Path("C:/Users/meidelvein.ps/Downloads/Auto/FORM_CWBEM.docx"),
    'FOUR HANDS': Path("C:/Users/meidelvein.ps/Downloads/Auto/FORM_FOUR_HANDS.docx")
}


# Caminho da pasta onde os formulários serão salvos
pasta_caminho = Path("C:/Users/meidelvein.ps/Downloads/FORMULARIOS/TESTES")
    ...
    if pd.notna(empresa) and pd.notna(nome) and pd.notna(cpf) and pd.notna(identificador):
        ...
        if template_path and Path(template_path).exists():
            try:
                ...
                caminho_arq = pasta_caminho / f'{identificador}.docx'
